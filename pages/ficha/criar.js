...
export default function Page() {
	...
	return (
		<Main>
			...
			{ points !== null && <ContentPage.Description>
					<p>Sua selfie automática</p>
					<div>
						<Image src={ `https://avatars.dicebear.com/api/big-smile/${ name || bgColor.replace('#','') }.png?b=%23${ bgColor.replace('#','') }` } width={ 128 } height={ 128 } alt="Selfie" quality={ 100 } />
					</div>
				</ContentPage.Description>
			}
			{ points !== null && name && <Input.Submit>Criar Personagem</Input.Submit> }
		</Main>
	)
}
